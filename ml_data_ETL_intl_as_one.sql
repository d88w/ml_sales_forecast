...
-----------
-----------
----------- TRAINING INTL Together
-----------
-----------
-----------
-----------

CREATE OR REPLACE VIEW periscope.sales_fcst_train_intl_together AS
(
...
FROM  (SELECT a.*, b.rate, a.amount AS amount_usd ---- amount in USD
  ...
  -----lab.dw_20190311_sales_owner_division_clean_up_intl_as_one
WHERE 1 = 1
...
CREATE OR REPLACE VIEW periscope.sales_fcst_test_intl_together AS
(
...
-----------
-----------
----------- TESTING CURRENT DAY INTL Together
-----------
-----------
-----------
-----------
...
CREATE OR REPLACE VIEW periscope.sales_fcst_test_curr_day_intl_together AS
(
...
-----------
-----------
----------- SAME TIME LAST QUARTER INTL Together
-----------
-----------
-----------
-----------
...
CREATE OR REPLACE VIEW periscope.sales_fcst_stlq_intl_together AS
(
...
-----------
-----------
----------- SAME TIME LAST 4 QUARTERS AVG INTL Together
-----------
-----------
-----------
-----------
...
CREATE OR REPLACE VIEW periscope.sales_fcst_stl4q_avg_intl_together AS
(
...
SELECT *
FROM periscope.sales_fcst_train_intl_together;

SELECT *
FROM periscope.sales_fcst_test_intl_together;

SELECT *
FROM periscope.sales_fcst_test_curr_day_intl_together;

SELECT *
FROM periscope.sales_fcst_stlq_intl_together;

SELECT *
FROM periscope.sales_fcst_stl4q_avg_intl_together;
